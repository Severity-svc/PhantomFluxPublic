...
--// Data
Utility.FruitsData = require(game:GetService("ReplicatedStorage").Data.SeedData)
Utility.Gears = require(game:GetService("ReplicatedStorage").Data.GearData)
Utility.Mutations = require(game:GetService("ReplicatedStorage").Modules.MutationHandler).MutationNames
Utility.EggData = require(game:GetService("ReplicatedStorage").Data.PetEggData)
Utility.NotificationHandler = require(game:GetService("ReplicatedStorage").Modules.Notification)
Utility.DataService = require(game:GetService("ReplicatedStorage").Modules.DataService)
Utility.InventorySerice = require(game:GetService("ReplicatedStorage").Modules.InventoryService)
